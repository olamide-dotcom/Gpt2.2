      ...
      <div className="space-y-6">
        {locationState?.blockedFromDashboard ? (
          <div className="rounded-2xl border border-gold/30 bg-gold/10 px-5 py-4 text-sm text-foreground">
            The dashboard unlocks after the first approved deposit. Submit a deposit request below, review it in the
            local console, then continue into the AI trading area.
          </div>
        ) : null}
