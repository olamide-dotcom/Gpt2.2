...
const Strategies = ({ onSelectStrategy }: StrategiesProps) => (
  <section id="strategies" className="scroll-mt-24 bg-card/50 py-24 px-4">
    <div className="container mx-auto text-center">
      <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground">Choose your trading style</h2>
      <p className="text-muted-foreground mt-3 max-w-lg mx-auto">
        Pick the pace that feels right for you. You can carry this choice straight into your account setup.
      </p>
        ...
        {strategies.map((strategy, index) => (
          ...
          >
            ...
            <p className="mt-4 text-sm text-foreground">
              <span className="font-medium">Style pace:</span> {strategy.reviewCadence}
            </p>
            ...
            >
              Pick this style <ArrowRight size={15} />
            </button>
          </motion.div>
        ))}
      </div>
