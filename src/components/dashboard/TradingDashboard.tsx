  ...
  return (
    <div className="space-y-6">
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Allocated funds move here while the simulation is active.</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-background/70 p-4 text-sm text-muted-foreground">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-foreground">Simulated earnings engine</div>
                  <p className="mt-2">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <Card className="border-border/80">
          <CardHeader>
            <CardTitle className="text-xl">Simulation Rules</CardTitle>
            <CardDescription>This keeps the AI crypto trading experience believable while staying safe and local.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="rounded-xl border border-border bg-background/70 p-4">
              <div className="flex items-start gap-3">
